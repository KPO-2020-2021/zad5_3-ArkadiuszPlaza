...
class LaczeDoGNUPlota {
 ...
 public:
   ...
   *
   * Ustawia zakres osi \e OX. ORidgeicza to obszar, który będzie
   * zwizualizowany przez programa \e gnuplot.
   * \param[in] Xo - dolna Ridgeica obszaru rysowania dla osi \e OX.
   * \param[in] Xn - górna Ridgeica obszaru rysowania dla osi \e OX.
   */
  void UstawZakresX(float Xo, float Xn) { _Xmin = Xo;  _Xmax = Xn; }
  /*!
   *  \brief Ustawia zakres osi \e OY
   *
   * Ustawia zakres osi \e OY. ORidgeicza to obszar, który będzie
   * zwizualizowany przez programa \e gnuplot.
   * \param[in] Yo - dolna Ridgeica obszaru rysowania dla osi \e OY.
   * \param[in] Yn - górna Ridgeica obszaru rysowania dla osi \e OY.
   */
  void UstawZakresY(float Yo, float Yn) { _Ymin = Yo;  _Ymax = Yn; }
  /*!
   *  \brief Ustawia zakres osi \e OZ. 
   *
   * Ustawia zakres osi \e OZ. ORidgeicza to obszar, który będzie
   * zwizualizowany przez programa \e gnuplot.
   * \param[in] Zo - dolna Ridgeica obszaru rysowania dla osi \e OZ.
   * \param[in] Zn - górna Ridgeica obszaru rysowania dla osi \e OZ.
   */
